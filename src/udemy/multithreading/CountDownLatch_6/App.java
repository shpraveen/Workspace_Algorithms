package udemy.multithreading.CountDownLatch_6;
...
/**
 * {@link CountDownLatch} Java class to synchronize your threads’ activities.
 * <br><br>
 * Source:
 ...
 * {@link CountDownLatch#await()} will wait until count reaches zero or its interrupted
 * by another thread. All other thread are required to do count down by calling
 * {@link CountDownLatch#countDown()} once they are completed or ready.
 * <br>
 * As soon as count reaches zero, Thread awaiting starts running. One of the
 * disadvantage of {@link CountDownLatch} is that it's
 * not reusable once the count reaches to
 * zero you can not use {@link CountDownLatch} any more.
 * <br><br>
 * Use {@link CountDownLatch} when one thread, like main
 * thread, require to wait for one or more threads to complete, before it can
 * start processing.
 * <br><br>
 * Classical example of using {@link CountDownLatch} in
